...
class UsersController {
  ...
  async create(request: Request, response: Response) {
    ...
    try {
      ...
      if ((!address && !coordinates) || (address && coordinates)){
        logger.warn({ message: 'Provide only address or coordinates, not both or neither', route: '/users/create' });
      ...
      logger.info({ message: 'User created successfully', route: '/users/create' });
  ...
  async update(request: Request, response: Response) {
    ...
    try {
      ...
      if (!userId){
        logger.warn({ message: 'User ID is required for updating', route: '/users/update' });
      ...
      logger.info({ message: 'User updated successfully', route: '/users/update' });
  ...
  async delete(request: Request, response: Response) {
    ...
    try {
      ...
      logger.info({ message: 'User deleted successfully', route: '/users/delete' });
